...
아래 표는 로컬 실행 결과를 집계합니다. [2026년 9월 13일 원격 CI](https://github.com/rkttu/hwplibsharp/actions/runs/34742873642)에서는
`net8.0`과 `net472` 각각 네트워크 테스트를 포함한 173개 모두 통과했으며 건너뛴 테스트는 없습니다.
